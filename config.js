  ...
  bios: [
    {
      ...
      statLine: {
        ...
        rows: [
          ["25-26", "82", "3090", "13", ".495", ".427", ".834", "543", "352", "180", "42", "2491", "30.4"],
          ["CAREER", "766", "29600", "3759", ".512", ".332", ".844", "4879", "4377", "2025", "739", "24489", "32.0"],
        ],
      },
    },
    {
      ...
      statLine: {
        columns: ["Season", "G", "Min", "Lasagna", "FG", "3pt", "FT", "Reb", "Ast", "Stl", "Blk", "Tot", "PG"],
        rows: [
          ["25-26", "61", "1850", "92", ".401", ".298", ".712", "210", "96", "54", "18", "1102", "18.1"],
          ["CAREER", "402", "14200", "18003", ".418", ".311", ".733", "1890", "1024", "512", "201", "9876", "19.6"],
        ],
      },
    },
  ],
  ...
  planets: [
    {
      ...
      page: {
        ...
        blurb:
          "Here you will find a curated list of Off The Domes, Book\nCover Recs, Venus Tidbits, or any other ideas/suggestions that we\nseem fit. All straight from the public, shown to the public.",
        blurbColor: "#6ec6ff",
        blurbGlow: "#ffe14d",
        blurbCenter: true,
        blurbFont: "sans",
    ...
    },
    {
      ...
      page: {
        ribbon: "Find The Latest Issue Of Written From The Hip Here",
    ...
    },
    {
      ...
      page: {
        ribbon: "Subscribe To Be A Founding Member",
    ...
    },
    {
      ...
      page: {
        ribbon: "We Love and Support Venus Williams Here At WFTH",
        ...
        blurbBox: { from: "#1565c0", to: "#0a1f38", width: 762 },
        blurbColor: "#ffe14d",
        blurbGlow: true,
        blurbFont: "oval",
        storyLink: {
        ...
        mapBlurb: "Venus Williams.",
        mapLinks: [{ label: "Play Lil Sis", href: "pong.html" }],
      },
    },
    {
      id: "fark",
      ...
      page: {
        ...
        blurbColor: "#ffe14d",
        blurbBold: true,
        subBlurb: { text: "WEEK ONE FARK: CJ BAILEY", color: "#ff3b3b" },
        centerPhoto: { photo: "assets/images/FARK WEEK ONE.png", glow: "#ff3b3b" },
      },
    },
    {
      id: "book-coverz",
      ...
      page: {
        ...
        blurbBox: { from: "#f08a1e", to: "#8a3a00", width: 600 },
        blurbColor: "#6ec6ff",
        blurbFont: "oval",
        bookshelf: true,
        books: [
          {
            photo: "assets/images/book-holy-bible.png",
            href: "https://churchsource.com/products/kjv-gift-and-award-bible-red-letter-edition-comfort-print-holy-bible-king-james-version?currency=USD&country=US&variant=32599840292961&stkn=0537a4b57eb9&gad_source=1&gad_campaignid=997600290&gbraid=0AAAAADkmkWJDtHsJi5I2FQjXV-EWoar4t&gclid=Cj0KCQjwzsjVBhC3ARIsALnMv4mxUqyRimZfFpB1lPNmyvXsl17Zytmu5TSqLktDgAPinTS2GlCtJwEaAnWpEALw_wcB",
            shelf: 0,
            caption: "Holy Bible 2/10",
          },
        ],
      },
    },
