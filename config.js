...
FIN`,
  ...
  planets: [
    ...
    },
    {
      ...
      page: {
        topBanner: { text: "The Judgement of Books only by how cool the cover is", color: "#f5871f" },
        oval: { fill: "#1f5c3a", text: "#ffd700", label: "Weekly Book Cover Recommendations" },
        blurb:
          "We a have weekly WFTH Best Seller, judging books fully based off of the cover. Feel free to buy these books and put them on your nightstand or coffee table, so people can think you know how to read, we will also provide what to say when someone asks what the book is about.",
